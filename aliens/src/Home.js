...
function Home() {
  return(
    <div>
      ...
      <p>Watch <span className="title">Ancient Aliens </span><a target="_blank" href="http://watchancientaliensonline.blogspot.com">here <span role="img" aria-label="UFO emoji">🛸</span></a></p>
    </div>
  )
}
